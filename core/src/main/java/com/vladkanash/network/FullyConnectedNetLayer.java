 ...
 */
public class FullyConnectedNetLayer extends ConvolutionNetLayer {

    private final MathOperations mathOperations = ApacheMathOperations.getInstance();

    FullyConnectedNetLayer(Dimension inputDimension, int neuronCount, ActivationFunction activationFunction) {
        super(inputDimension, inputDimension, neuronCount, activationFunction);
    }
